            ...
            <tbody id="myTopicTbl">
                <c:forEach var="user" items="${users}" >
                    <tr id="${user.id}">
                        ...
                        <td>${user.major}</td>
                        <td>
                            <span class="small-text">Modificar:</span><a href="Instructors?action=addStudent&mode=&stu_id=${user.id}" class="close-icon"><span class="small-text">Editar</span><i class="fa fa-pencil"></i></a>                            
                            &nbsp;
                            &nbsp;
