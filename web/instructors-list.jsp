                ...
                <section class="breadcrumb">
                    <div class="container">
                        <ul>
                            ...
                            <li><a href="/CienciasBasicas/Instructors?action=view&mode=list">Instructores</a></li>
                        </ul>
                    </div>
                </section>
                <section class="courses-view list-view">
                    <div class="container">
                        <div class="filter-row">
                            <div class="view-type">
                                <a href="/CienciasBasicas/Instructors?action=view&mode=grid"><i class="fa fa-th-large"></i></a>
                                <a href="/CienciasBasicas/Instructors?action=view&mode=list" class="active"><i class="fa fa-list"></i></a>
                            </div>
                            <div class="search">
                ...
                <section class="our-teacher">
                        ...
                        <c:forEach var="user" items="${users}" >
                            ...
                            <div class= "course-post">
                                <div class="img" >
                                    <img src="${pageContext.request.contextPath}/image/${user.picPath}" alt="No Image Available">
